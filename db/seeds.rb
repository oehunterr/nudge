...
habit2 = Habit.create!(title: "Meditation 🧘", description: "Meditating 3 times a week", start_date: Date.today - 6.month, end_date: Date.today + rand(1..100).day, user: third_user, master: false)
...
habit4 = Habit.create!(title: "Journalling 🖋", description: "Journalling 5 times a week", start_date: Date.today - 6.month, end_date: Date.today + rand(1..100).day, user: third_user, master: false)
...
Milestone.create!(title: 'Running 10k', description: '10k - 2 weeks', start_time: Date.today - 150.day, end_time: Date.today - 149.day, habit: habit1, completed: true)
...
Milestone.create!(title: 'The Big One', description: 'The big one in a year', start_time: Date.today - 1.day, end_time: Date.today, habit: habit1, completed: true)

Milestone.create!(title: 'Meditate', description: 'Meditate for 5 mins one evening', start_time: Date.today - 20.day, end_time: Date.today - 15.day, habit: habit2, completed: true)
