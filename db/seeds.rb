...
habit1 = Habit.create!(title: "Coding-Rails", description: "Building a rails application", start_date: DateTime.parse('20150823 12: 44: 05'), end_date: DateTime.parse('20150910 12: 44: 05'), user: first_user, master: true )
...
habit5 = Habit.create!(title: "Marathon", description: "Marathon prep (12 months)", start_date: DateTime.parse("20221214 12: 00: 00"), end_date: DateTime.parse("20231214 12: 00: 00"), user: first_user, master: false)
...
Milestone.create!(title: 'running 15k', description: 'in 2 months can run 15k none stop', start_time: DateTime.parse('20221228 12: 00: 00'), end_time: DateTime.parse('20230105 12: 00: 00'), habit: habit1, completed: true)
